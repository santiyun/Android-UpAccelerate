...
public class MainActivity extends BaseActivity {
    ...
    private void joinChannel() {
        ...
        mPushUrl = "rtmp://push.3ttest.cn/sdk2/" + roomId;
        ...
        // 5.设置本地视频编码参数，这里推荐使用如下参数。
        mTTTEngine.setVideoProfile(528, 960, 15, 1600); // 宽，高，帧率，码率
        // 6.加入频道
            ...
            if (MyTTTRtcEngineEventHandler.TAG.equals(action)) {
                ...
                switch (mJniObjs.mJniType) {
                    ...
                    case LocalConstans.CALL_BACK_ON_CAMERA_CONNECT_ERROR:
                        ...
                        break;
                    case LocalConstans.CALL_BACK_ON_RTC_PUSH_STATUS:
                        if (!mJniObjs.mPushStatus) {
                            mTTTEngine.updateRtmpUrl(mPushUrl);
                        }
                        break;
                }
            }
